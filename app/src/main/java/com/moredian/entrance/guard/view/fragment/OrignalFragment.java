...
public class OrignalFragment extends BaseFragment {
            ...
            public void onRespnse(Object o) {
                if (o instanceof GetDepartmentList) {
                    ...
                    for (int i = 0; i < typelength; i++) {
                        ...
                        Log.d(TAG, "onRespnse: " + ((GetCardTypeList) o).getContent().get(i).getName());
                        Log.d(TAG, "onRespnse: " + ((GetCardTypeList) o).getContent().get(i).getId());
    ...
    public void onStop() {
        ...
        Log.d(TAG, "onStop: "+ (String) spinnerCardtype.getSelectedItem());
        Log.d(TAG, "onStop: "+ typemap.get((String) spinnerCardtype.getSelectedItem()));
