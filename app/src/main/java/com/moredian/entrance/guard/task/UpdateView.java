...
import com.moredian.entrance.guard.http.RetrofitClient;
...
//            String verjson = getContent("http://machine_api.dt128.com/Api/VersionRepository/Highest?operatingSystem=android&type=em&extensionName=.apk");
            ...
            Call<UpdateInfo> call = RetrofitClient.getClient(Constants.SERVER_URL).create(UpdateCenterService.class).syncUpdate("Android_FM");
